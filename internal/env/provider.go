...
// WithEnvOps sets custom environment operations (for testing).
...
// ops returns the EnvOps implementation, defaulting to real OS operations.
func (p *Plugin) ops() EnvOps {
	if p.envOps != nil {
		return p.envOps
	}
