# scafctl-plugin-env - AI Agent Instructions

## Overview

scafctl provider plugin implementing the **env** provider.

## Key Patterns

- **Plugin SDK**: Uses `github.com/oakwood-commons/scafctl-plugin-sdk`
- **Entry point**: `cmd/scafctl-plugin-env/main.go` calls `sdkplugin.Serve()`
